...
# ==========================================
# הגדרות (אותן הגדרות כמו קודם)
# ==========================================
ENDPOINT = "a3dznsh4cnffd8-ats.iot.eu-north-1.amazonaws.com"
CLIENT_ID = "MacBook_Remote_Key" # שינינו שם כדי לא להתנגש
TOPIC = "iot/course/project/door"

# נתיבים לתעודות (משתמשים בנתיבים שכבר הגדרנו ועבדו)
...
# ==========================================
try:
    print("\nSending OPEN command to the door...")
    
    # שליחת הפקודה "OPEN" בדיוק כמו שה-ESP32 מצפה
    ...
    # מחכים קצת כדי לוודא שההודעה יצאה לפני שמתנתקים
    time.sleep(2)
